...
# COPIED FROM
# https://gitlab.com/getindata/internal/aa_team_kagle_hm/-/blob/main/src/vertex_ai_plugin_demo/image_embeddings/model/encoders.py
...
class EncoderConvBase(nn.Module):
    def __init__(self, embedding_size: int = 32, image_size: List[int] = [128, 128]):
        ...
        self.encoder_lin = nn.Sequential(
            nn.Linear(262144, 128), nn.ReLU(), nn.Linear(128, self.embedding_size)
        )
...
class EncoderConvLin1024(nn.Module):
    def __init__(self, embedding_size: int = 32, image_size: List[int] = [128, 128]):
        ...
        self.encoder_lin = nn.Sequential(
            nn.Linear(262144, 1024), nn.ReLU(), nn.Linear(1024, self.embedding_size)
        )
...
class EncoderConvCompr(nn.Module):
    def __init__(self, embedding_size: int = 32, image_size: List[int] = [128, 128]):
        ...
        self.encoder_lin = nn.Sequential(
            nn.Linear(32768, 128), nn.ReLU(), nn.Linear(128, self.embedding_size)
        )
...
class EncoderConvCompr3Layer(nn.Module):
    def __init__(self, embedding_size: int = 32, image_size: List[int] = [128, 128]):
        ...
        self.encoder_lin = nn.Sequential(
            nn.Linear(8192, 128), nn.ReLU(), nn.Linear(128, self.embedding_size)
        )
...
class EncoderConvCompr3LayerV2(nn.Module):
    def __init__(self, embedding_size: int = 32, image_size: List[int] = [128, 128]):
        ...
        self.encoder_lin = nn.Sequential(
            nn.Linear(8192, 512), nn.ReLU(), nn.Linear(512, self.embedding_size)
        )
...
class EncoderConvCompr3LayerV3(nn.Module):
    def __init__(self, embedding_size: int = 32, image_size: List[int] = [128, 128]):
        ...
        self.encoder_lin = nn.Sequential(nn.Linear(8192, self.embedding_size))
...
class EncoderConvLarger1stKernel(nn.Module):
    def __init__(self, embedding_size: int = 32, image_size: List[int] = [128, 128]):
        ...
        self.encoder_lin = nn.Sequential(nn.Linear(7200, self.embedding_size))
