...
# gid_ml_framework documentation build
...
from gid_ml_framework import __version__ as release

# -- Project information -----------------------------------------------------

project = "gid_ml_framework"
author = "QuantumBlack"
...
htmlhelp_basename = "gid_ml_frameworkdoc"
...
latex_documents = [
    (
        master_doc,
        "gid_ml_framework.tex",
        "gid_ml_framework Documentation",
        "QuantumBlack",
        "manual",
    )
]
...
texinfo_documents = [
    (
        ...
        author,
        "gid_ml_framework",
        "Project gid_ml_framework codebase.",
        "Data-Science",
    )
]
