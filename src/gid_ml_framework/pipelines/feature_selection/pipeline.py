...
def create_pipeline(**kwargs) -> Pipeline:
    ...
    feature_selection_pipeline = pipeline(
        ...
        inputs=["automated_articles_features_temp", "automated_customers_features_temp", "manual_articles_features_temp", "manual_customers_features_temp"],
        outputs=["automated_articles_columns", "automated_customers_columns", "manual_articles_columns", "manual_customers_columns"],
    )
