...
class HMDataLoader(pl.LightningDataModule):
    def __init__(self, data_dir: str, batch_size: int = 32, num_workers=0):
        super().__init__()
    ...
    def val_dataloader(self):
        return DataLoader(self.hm_val, batch_size=self.batch_size, shuffle=True, num_workers=self.num_workers)
