...
def register_pipelines() -> Dict[str, Pipeline]:
    ...
    return {
        ...
        "candidate_generation_training": (filter_latest_transactions_pipeline + train_val_split_pipeline + candidate_generation_pipeline + candidate_generation_validation_pipeline),
        ...
        "feature_engineering_training": (feature_engineering_manual_pipeline + feature_engineering_automated_pipeline + feature_selection_pipeline + feature_selection_apply_pipeline),
        "feature_engineering_inference": (feature_engineering_manual_pipeline + feature_engineering_automated_pipeline + feature_selection_apply_pipeline),
        ...
        "end_to_end_training": (
            ...
            feature_engineering_manual_pipeline + feature_engineering_automated_pipeline + feature_selection_pipeline + feature_selection_apply_pipeline +
            candidates_feature_engineering_pipeline +
            merge_candidate_features_pipeline + ranking_pipeline
        ),
        "end_to_end_inference": (
            filter_latest_transactions_pipeline +
            candidate_generation_pipeline +
            feature_engineering_manual_pipeline + feature_engineering_automated_pipeline + feature_selection_apply_pipeline +
            candidates_feature_engineering_pipeline +
